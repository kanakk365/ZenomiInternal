...
// Single course available for purchase
const SINGLE_COURSE: CourseCard = {
  id: "cmhxa9lro0000qe3ctmwl2vb2",
  title: "Emotional Regulation in Teens",
...
export default function CoursesPage() {
  ...
  const handleBuyClick = (planType: "standard" | "premium") => {
    ...
    if (planType === "standard") {
      // Pre-select the single course for Standard Plan
